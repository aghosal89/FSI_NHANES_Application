...
abline(h=0, color="red4", lty="dotted")
...
legend(-1, 25, legend=c("t=0.50","t=0.75","t=0.90","t=0.97"),
       ...
       lwd=c(1.5,2,2.5,3,3.5), lty=c(1,1,1,1,1), cex=1.2, text.font=10, bg='lightgrey')
...
postscript(file = "Rplot_histogram_ofSI.eps", width = 4.5, height = 4.5, 
           paper = 'special')
...
plot(tt, pred_diff_3rdq, type= "l", lty=2, col="red2", ylab="Absolute differences",
     xlab="Order of Quantiles", main="Absolute differences across quantiles", lwd=1.5)
lines(tt, pred_diff_med, type= "l", col="black", lwd= 1.5)
lines(tt, pred_diff_1stq, type= "l", lty=5, col=4, lwd=1.5)
